...
UNAPPROVED_MSG = (
    ...
    "`My queen hasn't approved you to PM.` "
    "`Please wait for my queen to look in, she mostly approves PMs.`\n\n"
    "`As far as I know, she doesn't usually approve retards though.`")
# =================================================================
        ...
        if event.is_private and event.chat_id != 777000 and event.chat_id != self_user.id and not (
            ...
            if not apprv and event.text != UNAPPROVED_MSG:
                ...
                if COUNT_PM[event.chat_id] > 4:
                    await event.respond("`You were spamming my queen's PM, `"
                                        "` which I don't like.`"
                                        "` I'mma Report Spam.`")
                    ...
                    try:
                        ...
                        LOGS.info("CountPM wen't rarted gurl")
                        return
...
async def unblockpm(unblock):
    ...
    if unblock.reply_to_msg_id:
        ...
        await unblock.edit("`My Queen has forgiven you to PM now`")
